...
X-Context: Threat intelligence course
-->

# Threat intelligence course

## Introduction
This repository contains the source material for Menacit's threat intelligence course.
It is designed to be instructor-led and collaboratively improved by the students/community.  
  
A rendered version of all the presentations can be previewed [here](https://t.menacit.se/ti).  
